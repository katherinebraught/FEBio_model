...
def threshold_and_strain_data(infile, outfile, threshholdvaluefile):
...
def export_new_FEB_file(inputfile, outputfile, elements_to_remove, time):
   ...
   #remove extra generations and update start time
    ...
    #new_muc_element[
    print (type(new_muc_element['elem']))
...
if len(sys.argv) != 7:
	print("Error: call program as extract.py inputfile outputfile areastrainElementsFile febioInputFile newfebioInputFileName timepoint")
	exit()

inputfile = sys.argv[1]
outputfile = sys.argv[2]
areastrainElementsFile = sys.argv[3]
FEB_in = sys.argv[4]#"test.in"
FEB_out = sys.argv[5]#"test.feb"
TIMEPOINT = sys.argv[6]


threshhold_elements = threshold_and_strain_data(inputfile, outputfile, areastrainElementsFile)
